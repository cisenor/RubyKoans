...
class AboutSymbols < Neo::Koan
  ...
  # Otherwise :test == :test, if :test doesn't exist, this check will create it and pollute the env.
  # testing "test" == "test" will be fine.
  ...
  def test_to_s_is_called_on_interpolated_symbols
    ...
    symbol = :sheep
    string = "It is raining #{symbol} and dogs."
    assert_equal "It is raining sheep and dogs.", string
  end
