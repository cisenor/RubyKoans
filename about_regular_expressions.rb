...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_caret_anchors_to_the_start_of_lines
    # ^ = start of line. \n creates a new line. 2 is the beginning of a new line.
  ...
  def test_variables_can_also_be_used_to_access_captures
    # The comma is a gotcha. Must be blah, foo
  ...
  def test_sub_is_like_find_and_replace
    # Replaces the first instance found in the string with the first letter of the found match.
